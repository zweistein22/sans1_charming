"""NICOS GUI configuration for SANS1."""

main_window = docked(tabbed(('Console', vsplit(panel('nicos.clients.gui.panels.status.ScriptStatusPanel'),
             #panel('nicos.clients.gui.panels.watch.WatchPanel'),
             panel('nicos.clients.gui.panels.console.ConsolePanel',
                 watermark='nicos_mlz/sans1-charming/gui/watermark.png'),),),),
    ('Experiment info',
     panel('nicos.clients.gui.panels.expinfo.ExpInfoPanel')),
    ('NICOS devices',
     panel('nicos_mlz.sans1_charming.gui.clients.panels.devices.DevicesPanel1', icons=True,
           dockpos='right',)),)
